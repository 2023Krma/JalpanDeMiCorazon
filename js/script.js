...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // 🔸 CARGA DE DATOS DESDE FIRESTORE (GENÉRICO)
    // Importar Firebase (se asume que está disponible globalmente o via CDN)
    ...
    /**
     * Carga datos desde Firestore para una sección o subsección
     * @param {string} collection - Nombre de la colección en Firestore
     * @param {string} sectionId - ID de la sección (ej. 'presa_jalpan')
     * @param {boolean} isSubsection - Si es una subsección
     */
